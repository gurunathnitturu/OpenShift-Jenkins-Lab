...
def replicas = "1"
def devProject = "gurunathnitturu-dev" // TODO: Your dev project name goes here
def testProject = "gurunathnitturu-test" // TODO: Your test project name goes here
def prodProject = "gurunathnitturu-prod" // TODO: Your prod project name goes here
        ...
        stage("Setup") {
            steps {
                script {
                    openshift.withCluster(){
                    echo "in script"
                    openshift.withProject("gurunathnitturu-dev") {
